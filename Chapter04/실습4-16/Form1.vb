Public Class frmScroll
    ...
    Private Sub redBar_Scroll(sender As Object, e As ScrollEventArgs) Handles redBar.Scroll
        If e.Type = ScrollEventType.EndScroll Then ColorBox1()
        lblRed.Text = "RED " & redBar.Value.ToString("###")
    End Sub

    Private Sub greenBar_Scroll(sender As Object, e As ScrollEventArgs) Handles greenBar.Scroll
        If e.Type = ScrollEventType.EndScroll Then ColorBox1()
        lblGreen.Text = "GREEN " & greenBar.Value.ToString("###")
    End Sub

    Private Sub blueBar_Scroll(sender As Object, e As ScrollEventArgs) Handles blueBar.Scroll
        If e.Type = ScrollEventType.EndScroll Then ColorBox1()
